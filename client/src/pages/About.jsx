  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-5xl font-heading font-bold dark:text-white light:text-light-text mb-4">
          About AUGCVS
        </h1>
      ...
      <div className="card mb-12">
        <div className="flex items-start space-x-6">
          ...
          <div>
            <h2 className="text-3xl font-heading font-bold dark:text-white light:text-light-text mb-4">Our Mission</h2>
            <p className="dark:text-dark-text light:text-light-text leading-relaxed mb-4">
            ...
            <p className="dark:text-dark-text light:text-light-text leading-relaxed">
        ...
        {stats.map((stat, index) => (
          <div key={index} className="card text-center hover:scale-105 transition-transform">
            <div className="text-primary-500 mb-3 flex justify-center">
              ...
              <div className="text-3xl font-bold dark:text-white light:text-light-text mb-2">{stat.value}</div>
      ...
      {/* Features Section */}
      <div className="mb-12">
        <h2 className="text-3xl font-heading font-bold dark:text-white light:text-light-text mb-8 text-center">
          Key Features
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="card hover:dark:bg-dark-border hover:light:bg-gray-100 transition-colors cursor-pointer group"
            >
              <div className="text-primary-500 mb-4 group-hover:scale-110 transition-transform">
                {feature.icon}
              </div>
              <h3 className="text-xl font-semibold dark:text-white light:text-light-text mb-3">{feature.title}</h3>
      ...
      {/* Technology Stack */}
      <div className="card mb-12">
        <h2 className="text-3xl font-heading font-bold dark:text-white light:text-light-text mb-6">Technology Stack</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-primary-500 mb-2">MERN</div>
            <div className="text-sm dark:text-dark-muted light:text-light-muted">MongoDB, Express, React, Node.js</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-primary-500 mb-2">Tailwind</div>
            <div className="text-sm dark:text-dark-muted light:text-light-muted">Modern CSS Framework</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-primary-500 mb-2">Socket.IO</div>
            <div className="text-sm dark:text-dark-muted light:text-light-muted">Real-Time Communication</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-primary-500 mb-2">JWT</div>
      ...
      <div className="card">
        <div className="flex items-start space-x-6">
          ...
          <div>
            <h2 className="text-3xl font-heading font-bold dark:text-white light:text-light-text mb-4">Security & Privacy</h2>
            <ul className="space-y-3 dark:text-dark-text light:text-light-text">
      ...
      <div className="mt-12 card text-center">
        <h2 className="text-2xl font-heading font-bold dark:text-white light:text-light-text mb-4">Need Help?</h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <div className="px-4 py-2 dark:bg-dark-surface light:bg-light-surface rounded-lg">
            <div className="text-sm dark:text-dark-muted light:text-light-muted">Email</div>
            <div className="dark:text-white light:text-light-text">support@augcvs.edu.et</div>
          </div>
          <div className="px-4 py-2 dark:bg-dark-surface light:bg-light-surface rounded-lg">
            <div className="text-sm dark:text-dark-muted light:text-light-muted">Institution</div>
            <div className="dark:text-white light:text-light-text">Ambo University</div>
          </div>
        </div>
      </div>
    </div>
